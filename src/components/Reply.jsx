...
const Reply = ({ reply, currentUser, onVote, onDelete, onEdit }) => {
    ...
    <div className="p-4 mb-4 bg-gray-100 rounded-lg shadow-md">
      ...
      <div className="flex flex-col md:flex-row md:items-start mt-2 md:space-x-4">
        ...
        <div className="flex md:order-1 items-center md:flex-col md:space-y-2 md:mr-4 mt-2 md:mt-0">
          <button onClick={() => onVote(reply.id, 1)} className="flex md:flex-col items-center px-2 py-1 text-gray-600 rounded-md hover:bg-gray-100">
